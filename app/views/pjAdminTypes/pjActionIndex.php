...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-12">
        <div class="row">
            <div class="col-sm-10">
                <h2><?php echo __('infoTypesTitle', true); ?></h2>
            </div>
        </div><!-- /.row -->

        <p class="m-b-none"><i class="fa fa-info-circle"></i> <?php echo __('infoTypesBody', true);?></p>
    </div><!-- /.col-md-12 -->
</div>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <div class="row m-b-md">
                        ...
                        {
                        	?>
                            <a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminTypes&amp;action=pjActionCreate" class="btn btn-primary"><i class="fa fa-plus"></i> <?php __('lblAddType');?></a>
                            <?php 
                        }
                        ?>
                        </div><!-- /.col-md-6 -->
...
var pjGrid = pjGrid || {};
var myLabel = myLabel || {};
myLabel.type_image = <?php x__encode('type_image'); ?>;
myLabel.type = <?php x__encode('lblType'); ?>;
myLabel.type_car_models = <?php x__encode('type_car_models'); ?>;
myLabel.type_num_cars = <?php x__encode('type_num_cars'); ?>;
myLabel.status = <?php x__encode('lblStatus', false, true); ?>;
myLabel.active = <?php echo x__encode('filter_ARRAY_active'); ?>;
myLabel.inactive = <?php echo x__encode('filter_ARRAY_inactive'); ?>;
